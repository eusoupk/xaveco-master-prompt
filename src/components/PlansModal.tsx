...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    name: 'MENSAL',
    price: 'R$ 1',
    priceSuffix: 'no 1º mês · depois R$ 49,90/mês',
    badge: 'OFERTA EXCLUSIVA',
    description: 'Primeira cobrança de apenas R$ 1. A partir do 2º mês, R$ 49,90/mês. Renovação automática. Cancele quando quiser.',
